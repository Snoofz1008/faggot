...
namespace FadeBot
{
    public class PhotonClient : LoadBalancingClient, IConnectionCallbacks, IInRoomCallbacks, ILobbyCallbacks, IMatchmakingCallbacks, IPhotonPeerListener
    {
        ...
        {
            instance = this;
            AppId = "432d18c9-9348-4b90-bfbf-9f2a10e1f15b";
            ...
            AuthValues.AddAuthParameter("token", "3A5A7C9A33634FCCA7832436E0B760BD0EB75A731374FAFA957BFE8A139C44434E72EC649BAC80BFD9E8D2A0642019F3B5CFE5235C766E18C50B35105CCEA5C2");
            AuthValues.AddAuthParameter("user", "PC-SoftPaws");
